...
// /support — HEALPLACE_OPS + SUPER_ADMIN support ticket queue (HIPAA sprint).
// Role gate mirrors backend @Roles(HEALPLACE_OPS, SUPER_ADMIN).
    ...
    return (
      ...
      >
        <div
          ...
          data-testid="admin-support-access-denied"
        >
          <div
          ...
          <p className="text-sm mb-4" style={{ color: 'var(--brand-text-muted)' }}>
            You need HEALPLACE OPS or Super Admin access to view support tickets.
          </p>
          <Link
            href="/dashboard"
