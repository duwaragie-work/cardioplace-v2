...
//
// Role gate: MEDICAL_DIRECTOR, HEALPLACE_OPS, SUPER_ADMIN — same oversight
// group as /reports. Mirrors the 403 card layout for consistency.
    ...
    return (
      ...
      >
        <div
          ...
          data-testid="admin-adherence-access-denied"
        >
          <div
          ...
          <p className="text-sm mb-4" style={{ color: 'var(--brand-text-muted)' }}>
            You need Medical Director, HEALPLACE OPS, or Super Admin access to
