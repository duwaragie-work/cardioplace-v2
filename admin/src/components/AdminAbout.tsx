...
// Mirrors the patient-app About page so admins / providers see the same
// product story (mission, principles, timeline, team) when they land on
// /about. Reuses the about.* i18n keys (already present in admin's
// locales) and the team headshots (copied to admin/public).
...
export default function AdminAbout() {
  ...
  // Hash-anchor scroll on mount — matches the patient About so footer
  // links like /about#team work when navigating in from another page.
  useEffect(() => {
