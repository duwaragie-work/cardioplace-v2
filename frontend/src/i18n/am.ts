...
const am: Record<TranslationKey, string> = {
  ...
  'checkin.openSession.title': 'የመለኪያ ክፍለ-ጊዜ በሂደት ላይ',
  'checkin.openSession.body': 'ከ{min} ደቂቃ በፊት የመለኪያ ክፍለ-ጊዜ ጀምረዋል (እስካሁን {count} መለኪያ(ዎች))። ይህን መለኪያ ወደዚሁ ክፍለ-ጊዜ ይጨምሩ ወይስ አዲስ ክፍለ-ጊዜ ይጀምሩ?',
  'checkin.openSession.needsMore': 'ይህ ክፍለ-ጊዜ ለመገምገም ተጨማሪ መለኪያዎች ይፈልጋል · እስካሁን {count}።',
  'checkin.openSession.join': 'ወደዚህ ክፍለ-ጊዜ ጨምር',
  'checkin.openSession.startNew': 'አዲስ ክፍለ-ጊዜ ጀምር',
  ...
  'checkin.delay.back': 'ሰዓት ቀይር',
  'checkin.historical.note': "ገባኝ፣ ተቀምጧል። ይህ ንባብ ከአንድ ቀን በላይ ያስቆጠረ ነው፣ ስለዚህ በእሱ ላይ ምንም የቅጽበት ማንቂያ አናስነሳም። የእንክብካቤ ቡድንዎ አሁንም በታሪክዎ ውስጥ ያየዋል።",
  ...
  // Cluster 8 (Manisha 5/18/26, P0) — የአንጂኦኤዴማ ማንቂያ መልዕክቶች (ቅድሚያ 1)።
  'alert.angioedema.patientAce':
    'የፊትዎ፣ የከንፈርዎ ወይም የምላስዎ እብጠት ወይም ጉሮሮዎ መጥበቅ እንደተሰማዎት አሳውቀዋል። ይህ አስቸኳይ የሕክምና እርዳታ ይፈልጋል። በተጨማሪ የመተንፈስ ችግር ካለብዎ ወይም ጉሮሮዎ ከጠበበ አሁኑኑ 911 ይደውሉ። ካልሆነ ወደ ቅርብ ድንገተኛ ክፍል አሁኑኑ ይሂዱ። ዶክተርዎ ደህንነቱ የተጠበቀ መሆኑን እስኪነግርዎ ድረስ የደም ግፊት መድኃኒትዎን ከእንግዲህ አይውሰዱ።',
  'alert.angioedema.patientGeneric':
    'የፊትዎ፣ የከንፈርዎ ወይም የምላስዎ እብጠት ወይም ጉሮሮዎ መጥበቅ እንደተሰማዎት አሳውቀዋል። ይህ አስቸኳይ የሕክምና እርዳታ ይፈልጋል። በተጨማሪ የመተንፈስ ችግር ካለብዎ ወይም ጉሮሮዎ ከጠበበ አሁኑኑ 911 ይደውሉ። ካልሆነ ወደ ቅርብ ድንገተኛ ክፍል አሁኑኑ ይሂዱ።',
  'alert.angioedema.caregiver':
    'የፊታቸው፣ የከንፈራቸው ወይም የምላሳቸው እብጠት እንዳለ አሳውቀዋል። ይህ ከደም ግፊት መድኃኒቶቻቸው ለአንዱ አደገኛ ምላሽ ሊሆን ይችላል። የመተንፈስ ችግር ካለባቸው ወይም ጉሮሮአቸው ከጠበበ አሁኑኑ 911 ይደውሉ። ካልሆነ ወደ ቅርብ ድንገተኛ ክፍል አሁኑኑ ይውሰዷቸው። ያንን መድኃኒት ሌላ ጊዜ እንዲወስዱ አይፍቀዱ።',
  ...
  'checkin.optionD.screenA.title': 'ይህ ንባብ በጣም ከፍተኛ ነው',
  'checkin.optionD.screenA.body': 'የእርስዎ {bp} ንባብ በጣም ከፍተኛ ነው። እባክዎ ለ1 ደቂቃ በጸጥታ ይቀመጡ፣ ከዚያም ለማረጋገጥ ሁለተኛ ንባብ ይውሰዱ።',
  'checkin.optionD.screenA.retake': 'ሁለተኛ ንባብ ይውሰዱ',
  'checkin.optionD.screenA.cantNow': 'አሁን አልችልም',
  'checkin.optionD.screenB.title': 'ሁለተኛ ንባብዎን ይውሰዱ',
  'checkin.optionD.screenB.body': 'ለአንድ ደቂቃ ያህል ካረፉ በኋላ፣ ሁለተኛ ንባብዎን ከታች ያስገቡ።',
  'checkin.optionD.screenB.submit': 'ሁለተኛ ንባብ ላክ',
  'checkin.optionD.screenB.cantNow': 'ለአሁኑ ጨርሻለሁ',
  'checkin.optionD.screenB.bothNumbers': 'እባክዎ የላይኛውንም የታችኛውንም ቁጥር ያስገቡ።',
  'checkin.optionD.screenC.title': 'ንባብዎ ተመዝግቧል',
  ...
  'checkin.err.implausible': 'ይህ ንባብ ትክክል አይመስልም፣ የታችኛው ቁጥር ከላይኛው ያነሰ መሆን አለበት። እባክዎ ካፍዎን ይፈትሹና እንደገና ይሞክሩ።',
  'checkin.err.implausibleRepeat': 'መሣሪያዎ ያልተለመዱ ቁጥሮችን ማሳየቱን ከቀጠለ፣ ካፍውን እንደገና ያስተካክሉና ከመሞከርዎ በፊት 2 ደቂቃ በጸጥታ ይቀመጡ። ችግሩ ከቀጠለ የእንክብካቤ ቡድንዎን ያነጋግሩ።',
  ...
  // ─── Chat result cards (Phase/27) — MT AMHARIC, needs review ───────────────
  'chat.card.checkinSaved': 'መለኪያ ተቀምጧል',
  'chat.card.checkinFailed': 'መለኪያ ማስቀመጥ አልተቻለም',
  'chat.card.updated': 'መለኪያ ተዘምኗል',
  'chat.card.updateFailed': 'መለኪያ ማዘመን አልተቻለም',
  'chat.card.deleted1': 'መለኪያ ተሰርዟል',
  'chat.card.deletedN': '{count} መለኪያዎች ተሰርዘዋል',
  'chat.card.deleteFailed': 'መለኪያ መሰረዝ አልተቻለም',
  'chat.card.medLogged': 'መድሃኒት ተመዝግቧል',
  'chat.card.medFailed': 'መድሃኒት መመዝገብ አልተቻለም',
  'chat.card.symptomLogged': 'ምልክት ተመዝግቧል',
  'chat.card.symptomFailed': 'ምልክት መመዝገብ አልተቻለም',
  'chat.card.symptomCareTeamNotified': 'የእንክብካቤ ቡድንዎ ተነግሯል፣ በቅርቡ ይመለከታሉ።',
  'chat.card.photoConfirmTitle': 'ይህ ትክክል ነው?',
  'chat.card.photoConfirmHelp': 'እነዚህን ቁጥሮች ከፎቶዎ አንብቤያለሁ። ከካፍዎ ጋር ሲመሳሰል ብቻ ያረጋግጡ።',
  'chat.card.photoConfirm': 'አዎ፣ አስቀምጥ',
  'chat.card.photoEdit': 'በምትኩ ይጻፉ',
  'chat.card.photoRetake': 'እንደገና ያንሱ',
  'chat.card.photoFailed': 'ካፉን ማንበብ አልተቻለም',
  'chat.card.photoTypeInstead': 'ቁጥሮችን ይጻፉ',
  'chat.card.viewOnReadings': 'በመለኪያዎች ይመልከቱ',
  ...
  // ─── Profile v2 (Flow E) ───────────────────────────────────────────────────
  // 🚨 MT AMHARIC — REQUIRES NATIVE SPEAKER REVIEW BEFORE COHORT LAUNCH.
  // UI chrome. Condition + HF subtype labels reuse Flow A intake.a3.* keys.
  'profile.yourProfile': 'የእርስዎ መገለጫ',
  'profile.signOut': 'ውጣ',
  'settings.title': 'ቅንብሮች',
  // TODO(i18n): Amharic translation pending native-speaker review. English
  // placeholders below so the type stays satisfied and am users see English
  // (same as the getTranslation fallback) rather than unverified Amharic.
  ...
  'settings.notif.turnOn': 'ማሳወቂያዎችን አብራ',
  'settings.notif.turnOff': 'ማሳወቂያዎችን አጥፋ',
  'settings.notif.turnedOn': 'ማሳወቂያዎች ለዚህ መሣሪያ በርተዋል።',
  'settings.notif.turnedOff': 'ማሳወቂያዎች ለዚህ መሣሪያ ጠፍተዋል።',
  'settings.notif.blockedHelp': 'ማሳወቂያዎች በአሳሽዎ ውስጥ ታግደዋል። ለዚህ ጣቢያ በአሳሽ ቅንብሮች ውስጥ ይፍቀዱና እንደገና ይሞክሩ።',
  'settings.notif.unsupported': 'ይህ አሳሽ ወይም መሣሪያ ማሳወቂያዎችን አይደግፍም። በ iPhone ወይም iPad ላይ መጀመሪያ Cardioplace ን ወደ መነሻ ማያ ገጽ ያክሉ፣ ከዚያ ያብሩ።',
  'settings.notif.error': 'የሆነ ችግር ተፈጥሯል። እባክዎ እንደገና ይሞክሩ።',
  'settings.notif.working': 'በሂደት ላይ…',
  ...
  'profile.completeHealthProfile': 'የጤና መገለጫዎን ያጠናቅቁ →',
  'profile.notStarted': 'የጤና መገለጫ አልተጀመረም',
  ...
  'profile.emailCannotChange': '· ሊለወጥ አይችልም',
  'profile.dobLabel': 'የትውልድ ቀን',
  'profile.commPrefLabel': 'የግንኙነት ምርጫ',
  'profile.commPrefText': 'ጽሑፍ ይመረጣል',
  'profile.commPrefAudio': 'ድምጽ ይመረጣል',
  'profile.saving': 'በማስቀመጥ…',
  'profile.saveError': 'ለውጦችን ማስቀመጥ አልተቻለም።',
  'dob.errInvalid': 'ይህ ቀን ትክክል አይመስልም። እባክዎ ከካላንደሩ ይምረጡ።',
  'dob.errFuture': 'ይህ ቀን ወደፊት ነው። እባክዎ የተወለዱበትን ቀን ይምረጡ።',
  'dob.errToday': 'ዛሬ የልደት ቀንዎ ሊሆን አይችልም። እባክዎ የተወለዱበትን ቀን ይምረጡ።',
  'dob.errUnder18': 'ካርዲዮፕሌስ ለ18 ዓመት እና ከዚያ በላይ ለሆኑ አዋቂዎች ነው። እባክዎ የልደት ቀንዎን ያረጋግጡ።',
  'dob.errAncient': 'ይህ ቀን ትክክል አይመስልም። እባክዎ ዓመቱን ያረጋግጡ እና እንደገና ይሞክሩ።',
  'profile.saveChangesBtn': 'ለውጦችን አስቀምጥ',
  'profile.careTeam': 'የተንከባካቢ ቡድንዎ',
  'profile.personalInfoSection': 'የግል መረጃ',
  'profile.aboutYou': 'ስለ እርስዎ',
  'profile.pregnancySection': 'እርግዝና',
  'profile.conditionsSection': 'የጤና ሁኔታዎች',
  'profile.medicationsSection': 'መድሃኒቶች',
  'profile.practice': 'ክሊኒክ',
  'profile.primaryProvider': 'ዋና ሐኪም',
  'profile.backupProvider': 'ተተኪ ሐኪም',
  'profile.medicalDirector': 'የህክምና ዳይሬክተር',
  'profile.gender': 'ፆታ',
  'profile.heightLabel': 'ቁመት',
  'profile.currentlyPregnant': 'በአሁኑ ጊዜ እርጉዝ',
  'profile.dueDate': 'የመውለጃ ቀን',
  'profile.hfTypeLabel': 'የልብ ድካም አይነት',
  ...
  'profile.freqAsNeeded': 'እንደ አስፈላጊነቱ',
  'profile.freqUnknown': 'ድግግሞሹ አይታወቅም',
  'profile.hfHfrEf': 'HFrEF (የተቀነሰ የልብ መግፋት አቅም)',
  'profile.hfHfpEf': 'HFpEF (የተጠበቀ የልብ መግፋት አቅም)',
  'profile.hfToConfirm': 'አይነቱ መረጋገጥ አለበት',
  'profile.notSpecified': 'አልተገለጸም',
  'profile.noCareTeam': 'እስካሁን የተንከባካቢ ቡድን አልተመደበልዎትም። ሐኪም ሲመደብ ቡድንዎ እዚህ ይታያል።',
  'profile.noConditions': 'ምንም የጤና ሁኔታ አልተዘገበም።',
  ...
  'readings.notDueYet': 'ገና አልደረሰም',
  'readings.whyMissed': 'ለምን አመለጠ?',
  'readings.selectReason': 'ምክንያት ይምረጡ…',
  'readings.reasonForgot': 'ረሳሁ',
  'readings.reasonSideEffects': 'የጎንዮሽ ጉዳቶች',
  'readings.reasonRanOut': 'አለቀ',
  'readings.reasonCost': 'ዋጋ',
  'readings.reasonIntentional': 'ለመዝለል መረጥኩ',
  'readings.reasonOther': 'ሌላ',
  'readings.howManyDoses': 'ስንት ጊዜ?',
  'readings.decreaseDoses': 'የጎደሉ ጊዜዎችን ቀንስ',
  'readings.increaseDoses': 'የጎደሉ ጊዜዎችን ጨምር',
  ...
  'register.otpLengthHint': 'ሁሉንም 6 አሃዞች ያስገቡ ({n}/6)',
  ...
  'register.pleaseWaitMagicLink': 'አዲስ ሊንክ ከመጠየቅዎ በፊት 60 ሰከንድ ይጠብቁ',
  'register.failedMagicLink': 'ሊንኩን መላክ አልተሳካም።',
  ...
  'landing.healplaceCompany': 'የHealplace ኩባንያ',
  ...
  'home.goToDashboard': 'ወደ ዳሽቦርድ ይሂዱ',
  ...
  'intake.a1.heightQuestion': 'ቁመትዎ ምን ያህል ነው?',
  'intake.a1.heightAudio': 'ቁመትዎ ምን ያህል ነው?',
  'intake.a1.heightHint': 'የሚመርጡትን ክፍል ይምረጡ። እኛ ቁጥሩን ሁልጊዜ በሴንቲሜትር እናከማቻለን።',
  'intake.a1.heightFeetLabel': 'ጫማ',
  'intake.a1.heightInchesLabel': 'ኢንች',
  ...
  'intake.a3.aorticStenosisTitle': 'የአርታ ቫልቭ መጥበብ',
  'intake.a3.aorticStenosisDesc': 'የጠበበ የአርታ የልብ ቫልቭ',
  'intake.a3.aorticStenosisAudio': 'የአርታ ቫልቭ መጥበብ። የጠበበ የአርታ የልብ ቫልቭ።',
  ...
  'intake.a5.otherMedsTitle': 'ሌሎች መድሃኒቶችዎ',
  'intake.a5.otherMedEdit': 'አርትዕ',
  'intake.a5.otherMedDelete': 'አስወግድ',
  'intake.a5.otherMedEditModalTitle': 'መድሃኒት አርትዕ',
  'intake.a5.otherMedDrugLabel': 'የመድሃኒት ስም',
  'intake.a5.otherMedFrequencyLabel': 'ስንት ጊዜ',
  'intake.a5.otherMedSave': 'አስቀምጥ',
  'intake.a5.otherMedCancel': 'ይቅር',
  'intake.a5.otherMedDupError': '{name} አስቀድሞ በዝርዝርዎ ውስጥ ነው። ሌላ ስም ይምረጡ።',
  'intake.a5.otherMedCatalogHint': '{name} በካታሎግ ውስጥ ነው፣ የተረጋገጡ የተቃራኒ ምልክቶች ምርመራዎችን ለመጠቀም በዚያ ካርድ ላይ ይንኩ።',
  ...
  'intake.a10.conditionAorticStenosis': 'የአርታ ቫልቭ መጥበብ',
  ...
  'intake.nav.saveChanges': 'ለውጦችን አስቀምጥ',
  ...
  'intake.freq.asNeeded': 'እንደ አስፈላጊነቱ',
  ...
  'ocr.med.badgeAlready': 'ቀድሞ በዝርዝርዎ ውስጥ',
  'ocr.med.verifying': 'በማረጋገጥ ላይ…',
  'ocr.med.useCanonical': '{name}ን ተጠቀም',
  'ocr.med.willUpdateFreq': 'ድግግሞሹ ይቀየራል፦ {from} → {to}',
  'ocr.med.skip': 'ዝለል',
  'ocr.med.unskip': 'መልሰው ይጨምሩ',
  'ocr.med.addAll': '{count} ይጨምሩ',
  'ocr.med.addAllEmpty': 'መድሃኒቶችን ይጨምሩ',
  'ocr.med.addNothing': 'የሚጨመር ነገር የለም',
  'ocr.med.addNothingHelp': 'እነዚህ መድሃኒቶች አስቀድሞ በዝርዝርዎ ውስጥ ናቸው። ነባር መድሃኒት ለማዘመን ድግግሞሹን ይቀይሩ ወይም ይቅር የሚለውን ይንኩ።',
  'ocr.med.updateOnly': '{count} አዘምን',
  'ocr.med.addAndUpdate': '{add} ጨምር + {update} አዘምን',
  'ocr.med.cancel': 'ይቅር',
  'ocr.med.retake': 'እንደገና ያንሱ',
  'ocr.med.freqOnce': 'በቀን አንድ ጊዜ',
  'ocr.med.freqTwice': 'በቀን ሁለት ጊዜ',
  'ocr.med.freqThrice': 'በቀን ሶስት ጊዜ',
  'ocr.med.freqAsNeeded': 'እንደ አስፈላጊነቱ',
  ...
  // ─── Auth — የክፍለ ጊዜ ማስታወቂያዎች (የታካሚ መተግበሪያ ብቻ) ──────────────
  'auth.sessionExpired.title': 'ማስታወቂያ ከመለያዎ ወጥተዋል',
  'auth.sessionExpired.body':
    'እንቅስቃሴ ባለመኖሩ ክፍለ ጊዜዎ ተጠናቅቋል። ለመቀጠል እባክዎ እንደገና ይግቡ።',
  'auth.idleWarning.title': 'ማስጠንቀቂያ በቅርቡ ይወጣሉ',
  'auth.idleWarning.body':
    'እንቅስቃሴ ባለመኖሩ በ60 ሰከንድ ገደማ ውስጥ ከመለያዎ ይወጣሉ። የተገናኙ ሆነው ለመቆየት መዳፊትዎን ያንቀሳቅሱ ወይም ማንኛውንም ቁልፍ ይጫኑ።',
  'auth.idleWarning.stay': 'የተገናኙ ይቆዩ',
};
