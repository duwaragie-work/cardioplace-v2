        ...
        <div className="max-w-[820px] mx-auto">
          ...
          <div className="space-y-8 text-[#1f2937] text-[15px] leading-relaxed">
            ...
            <section>
              ...
              <p>
                Alerts are generated by automated rules signed off by a
                licensed physician. They are not a substitute for clinical
                judgment by your care team.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-4">
                We recommend you designate an emergency contact (a family
                member, neighbor, or trusted person) who knows you use
                Cardioplace and can respond if needed. You can share this
                information with your care team during onboarding.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                service under a Business Associate Agreement. Your voice
            ...
            <section>
              <h2 className="font-semibold text-[#170c1d] text-xl mb-3">8. Privacy of your information</h2>
              <p className="mb-3">
                Your protected health information (PHI) is handled in
                accordance with our{' '}
                <a href="/privacy" className="font-medium text-[#7B00E0] underline">
                  Privacy Policy
                </a>{' '}
              ...
              <p>
                ...
                protected. By using Cardioplace, you acknowledge you have
                received or have access to this Notice.
              </p>
            </section>

            <section>
              <h2 className="font-semibold text-[#170c1d] text-xl mb-3">9. Pilot status</h2>
              <p className="mb-3">
              ...
              <p className="mb-3">
                During the pilot, use of Cardioplace is provided at no charge
            ...
            <section>
              <h2 className="font-semibold text-[#170c1d] text-xl mb-3">10. Acceptable use</h2>
            ...
            <section>
              <h2 className="font-semibold text-[#170c1d] text-xl mb-3">11. Termination</h2>
              <p className="mb-3">
            ...
            <section>
              <h2 className="font-semibold text-[#170c1d] text-xl mb-3">12. How long we keep your information</h2>
              <p className="mb-3">
                Your account information and health data are retained for as
                long as your account is active and for an additional period
                required by law or applicable medical-records retention
                policies (typically seven years for adult medical records in
            ...
            <section>
              <h2 className="font-semibold text-[#170c1d] text-xl mb-3">13. Changes to these Terms</h2>
              <p>
                We may update these Terms from time to time. If we make
                material changes, we will notify you by email or through the
                platform before the changes take effect. Continued use of
                Cardioplace after the effective date constitutes acceptance
                of the updated Terms.
              </p>
            </section>

            <section>
              <h2 className="font-semibold text-[#170c1d] text-xl mb-3">14. Limitation of liability</h2>
              <p>
            ...
            <section>
              <h2 className="font-semibold text-[#170c1d] text-xl mb-3">15. Governing law</h2>
              <p>
            ...
            <section>
              <h2 className="font-semibold text-[#170c1d] text-xl mb-3">16. Contact</h2>
              <p>
                <a href="mailto:support@healplace.com" className="font-medium text-[#7B00E0] underline">
                  support@healplace.com
                </a>
